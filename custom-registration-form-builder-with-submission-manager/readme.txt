...
* Fixed: Account activation email being sent even when disabled from settings.
* Fixed: Newsletter integration not working with contact forms. (Premium Only)
* Security improvements.
* Minor bug fixes.

= 6.0.9.9: August 27 2026 =
* Security improvements.
* Minor bug fixes.
* Credit: Thanks to Charles Vosburgh, Vũ Quang Huy, Sai Praneeth Koti and Mutantgun for responsibly reporting security vulnerabilities.

= 6.0.9.8: August 11 2026 =
* Security improvements.
* Minor bug fixes.

= 6.0.9.7: August 1 2026 =
* Security patches.
...
= 6.0.9.1: June 17 2026 =
* Minor UI improvements.

= 6.0.9.0: June 11 2026 =
* Minor UI improvements & bug fixes.
...
* Fixed: Submission editing for legacy forms. (Premium Only)
* Minor bug fixes.

= 6.0.8.3: April 13 2026 =
* Minor bug fixes.

= 6.0.8.2: March 30 2026 =
* Fixed: Product quantity selection issue with maximum quantity disabled. (Premium Only)
* Minor bug fixes.

= 6.0.8.1: March 18 2026 =
* Fixed: Form design issues in mobile view.
* Fixed: Field order appearing incorrectly in the submissions list.
* Fixed: Missing asterisk on required fields.
* Minor bug fixes.

= 6.0.7.9: March 7 2026 =
* Minor UI improvements.

= 6.0.7.8: March 5 2026 =
* Minor UI improvements.

= 6.0.7.7: February 19 2026 =
* Security improvements.
* Minor bug fixes.

= 6.0.7.6: February 9 2026 =
* Fixed: Payment issue with incorrect price calculation.
* Security improvements.
* Minor bug fixes.
