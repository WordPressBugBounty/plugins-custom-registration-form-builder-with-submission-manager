            ...
            <tr>
                ...
                <td>
                    <div class="rm-form-badges-wrap rm-border-accent-color rm-border-opacity-50 rm-border-primary rm-border rm-rounded-1 rm-di-flex rm-bg-white">
                        <span class="rm-form-badge rm-lh-normal rm-ps-1 rm-p-1 rm-border-accent-color rm-border-opacity-50 rm-border-right rm-border-primary rm-di-flex rm-align-items-center rm-position-relative rm-tooltips"><a href="<?php echo esc_url(admin_url('admin.php?page=rm_login_analytics')); ?>" class="rm-lh-0 rm-form-badge-link"><span class="rm-form-badge-icon rm-form-badge-login-analytics"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="20px" viewBox="0 0 24 24" width="20px" fill="#3858e9"><rect fill="none" height="24" width="24"/><g><path d="M7.5,21H2V9h5.5V21z M14.75,3h-5.5v18h5.5V3z M22,11h-5.5v10H22V11z"/></g></svg></span></a><span class="rm-tooltip-wrap" > <span class="rm-tooltip-arrow"></span><?php esc_html_e('Login Analytics', 'custom-registration-form-builder-with-submission-manager'); ?></span></span>
                        <span class="rm-form-badge rm-lh-normal rm-ps-1 rm-p-1 rm-border-accent-color rm-border-opacity-50 rm-border-right rm-border-primary rm-di-flex rm-align-items-center rm-position-relative rm-tooltips"><a href="<?php echo esc_url(admin_url('admin.php?page=rm_login_val_sec')); ?>" class="rm-lh-0 rm-form-badge-link"><span class="rm-form-badge-icon rm-form-badge-pass-validation"><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 0 24 24" width="20px" fill="#3858e9"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/></svg></span></a><span class="rm-tooltip-wrap" > <span class="rm-tooltip-arrow"></span><?php esc_html_e('Validation & Security', 'custom-registration-form-builder-with-submission-manager'); ?></span></span>
                        <span class="rm-form-badge rm-lh-normal rm-ps-1 rm-p-1 rm-border-accent-color rm-border-opacity-50 rm-border-right rm-border-primary rm-di-flex rm-align-items-center rm-position-relative rm-tooltips"><a href="<?php echo esc_url(admin_url('admin.php?page=rm_login_recovery')); ?>" class="rm-lh-0 rm-form-badge-link"><span class="rm-form-badge-icon rm-form-badge-pass-recovery rm-fs-6"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="20px" viewBox="0 0 20 20" width="20px" fill="#3858e9"><g><rect fill="none" height="20" width="20"/></g><g><path d="M17.5,8.5h-6.75C10.11,6.48,8.24,5,6,5c-2.76,0-5,2.24-5,5s2.24,5,5,5c2.24,0,4.11-1.48,4.75-3.5h0.75L13,13l1.5-1.5L16,13 l3-3L17.5,8.5z M6,12.5c-1.38,0-2.5-1.12-2.5-2.5S4.62,7.5,6,7.5S8.5,8.62,8.5,10S7.38,12.5,6,12.5z"/></g></svg></span></a><span class="rm-tooltip-wrap" > <span class="rm-tooltip-arrow"></span><?php esc_html_e('Password Recovery', 'custom-registration-form-builder-with-submission-manager'); ?></span></span>
                        <span class="rm-form-badge rm-lh-normal rm-ps-1 rm-p-1 rm-border-accent-color rm-border-opacity-50 rm-border-right-0 rm-border-primary rm-di-flex rm-align-items-center rm-position-relative rm-tooltips"><a href="<?php echo esc_url(admin_url('admin.php?page=rm_login_sett_redirections')); ?>" class="rm-lh-0 rm-form-badge-link"><span class="rm-form-badge-icon rm-form-badge-redirection rm-fs-6"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="20px" viewBox="0 0 20 20" width="20px" fill="#3858e9"><rect fill="none" height="20" width="20"/><path d="M9.25,14C9.25,10.41,6,7.5,2,7.5V6c3.56,0,6.64,1.96,8,4.76c0.72-1.49,1.96-2.87,3.68-4.08L11.5,4.5H17V10l-2.24-2.24 c-1.78,1.21-4.01,3.28-4.01,6.24h1.5v1.5h-4.5V14H9.25z"/></svg></span></a><span class="rm-tooltip-wrap" > <span class="rm-tooltip-arrow"></span><?php esc_html_e('Redirections', 'custom-registration-form-builder-with-submission-manager'); ?></span></span>
                    </div> 
                </td>
            </tr>
            <?php } ?>
